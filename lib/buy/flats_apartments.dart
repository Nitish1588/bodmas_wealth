...
class FlatsApartmentsScreen extends StatelessWidget {
  const FlatsApartmentsScreen({super.key});

  final String headerImage =
      'https://www.bodmaswealth.com/assets/interestrate-DGnQqjyM.jpg'; // image URL

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.primary,
      appBar: AppBar(title: const Text("Flats/Apartments"),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Row(
                        children: [
                          _chip("Apartment", Colors.deepPurple),
              ...
              /// TITLE
              const Text(
                "2 BHK Modern Apartment in Dwarka",
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 18,
                  fontWeight: FontWeight.bold,

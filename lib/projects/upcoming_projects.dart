...
class UpcomingProjectsScreen extends StatelessWidget {
  const UpcomingProjectsScreen({super.key});

  final String headerImage =
      'https://www.shutterstock.com/shutterstock/photos/2432833247/display_1500/stock-photo-a-crane-stands-atop-a-tall-building-showcasing-ongoing-construction-work-in-an-urban-setting-2432833247.jpg'; // image URL

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.primary,
      appBar: AppBar(title: const Text("Upcoming Projects"),
                    ...
                    child: Stack(
                      children: [
                        SizedBox(
                          ...
                          width: double.infinity,
                          child: Image.network(
                            "https://www.shutterstock.com/shutterstock/photos/2739640541/display_1500/stock-photo-new-building-structure-with-masonry-block-walls-and-blue-scaffolding-illustrating-ongoing-2739640541.jpg",
                            fit: BoxFit.cover,
                          ),
                        ),
                          ...
                          children: const [
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    "DLF Phase 5, Golf Course Road,Gurgaon,Haryana",
                                    style: TextStyle(
                                      color: Colors.white70,
                                      fontSize: 14,
                                    ),

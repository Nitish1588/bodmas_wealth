...
class CommercialLoanScreen extends StatelessWidget {
  const CommercialLoanScreen({super.key});

  final String headerImage =
      'https://www.bodmaswealth.com/assets/CommercialLoan-Banner-CPtsMFg1.jpg'; // image URL

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.primary,
      appBar: AppBar(title: const Text("Commercial Loan"),
